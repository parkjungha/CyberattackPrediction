...
accountlist = pd.read_excel('C:/Users/jungh/Downloads/PredictCyberAttacks/Crawling/Follow/1000_screen_name/2.xlsx')
...
for username in usernames:
    ...
    with open('C:/Users/jungh/Downloads/PredictCyberAttacks/Crawling/Follow/1000_screen_name/test/'+username+'.json','r') as json_file:
